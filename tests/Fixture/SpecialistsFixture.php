...
class SpecialistsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'specialty' => ['type' => 'string', 'length' => 40, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'active' => 1,
            'created' => '2016-10-23 20:34:17',
            'modified' => '2016-10-23 20:34:17'
        ],
    ];
}
